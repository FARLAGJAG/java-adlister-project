...
<footer class="foot colorFooter container-fluid bottom  px-5 pt-3">
    <section class="row d-flex justify-content-center">
        ...
        <div class=" col-4 ">
            ...
            <ul class="list">
                ...
                <li class="address list-group-item"><a
                        href="https://www.google.com/search?q=code+up&oq=code+up&aqs=chrome.0.0i131i355i433i512j46i131i175i199i433i512j46i20i131i263i433i512j0i131i433j0i512j69i60l3.4664j0j7&sourceid=chrome&ie=UTF-8#lrd=0x865c5f53ae9da8c7:0xfdc2b9d926713c13,1,,,,">Google
                    Reviews</a></li>
            </ul>
        </div>
    </section>
    <section class="row bottom  border-top border-light mt-4">
        ...
        <div class="col-4 d-flex justify-content-end">
            <img class="" src="../../img/visa-master.png" alt="Visa and Master Card Logo" style="width: 6em"
                 height="auto"/>
        </div>
    </section>
